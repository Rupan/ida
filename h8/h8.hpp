...
static const proctype_t ADV   = 1;      // advanced mode (H8/300H, H8S/2000, H8S/2600)
static const proctype_t P300  = 2;      // H8/300, H8/300H
static const proctype_t P2000 = 4;      // H8S/2000
static const proctype_t P2600 = 8;      // H8S/2600
